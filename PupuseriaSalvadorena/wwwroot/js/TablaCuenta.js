...
function setupPagination() {
    var table = document.querySelector('#tablaPagos tbody');
    var rows = table.rows;
...
document.getElementById('busqueda').addEventListener('keyup', function () {
    ...
    var rows = document.querySelectorAll('#tablaPagos tbody tr');
...
// Ordernar tabla
document.querySelectorAll('#tablaPagos th').forEach(header => {
    if (!header.id.includes("acciones")) {
        header.addEventListener('click', function () {
            var table = document.querySelector('#tablaPagos');
            ...
            document.querySelectorAll('#tablaPagos th').forEach(th => {
