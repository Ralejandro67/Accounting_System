...
function setupPagination() {
    var table = document.querySelector('#tablaDeclaracion tbody');
    var rows = table.rows;
...
document.getElementById('busqueda').addEventListener('keyup', function () {
    ...
    var rows = document.querySelectorAll('#tablaDeclaracion tbody tr');
...
// Ordernar tabla
document.querySelectorAll('#tablaDeclaracion th').forEach(header => {
    if (!header.id.includes("acciones")) {
        header.addEventListener('click', function () {
            var table = document.querySelector('#tablaDeclaracion');
            ...
            document.querySelectorAll('#tablaDeclaracion th').forEach(th => {
