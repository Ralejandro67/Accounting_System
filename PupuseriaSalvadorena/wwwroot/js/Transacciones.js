...
function setupPagination() {
    var table = document.querySelector('#tablaTransacciones tbody');
    var rows = table.rows;
...
document.getElementById('busqueda').addEventListener('keyup', function () {
    ...
    var rows = document.querySelectorAll('#tablaTransacciones tbody tr');
...
// Ordernar tabla transacciones
document.querySelectorAll('#tablaTransacciones th').forEach(header => {
    if (!header.id.includes("acciones")) {
        header.addEventListener('click', function () {
            var table = document.querySelector('#tablaTransacciones');
            ...
            document.querySelectorAll('#tablaTransacciones th').forEach(th => {
