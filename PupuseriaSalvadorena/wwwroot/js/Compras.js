...
function setupPagination() {
    var table = document.querySelector('#tablaFacturas tbody');
    var rows = table.rows;
...
// Busqueda de facturas de compras
document.getElementById('busquedaF').addEventListener('keyup', function () {
    var searchTerm = this.value.toLowerCase();
    var rows = document.querySelectorAll('#tablaFacturas tbody tr');
...
// Ordernar tabla facturas de compras
document.querySelectorAll('#tablaFacturas th').forEach(header => {
    if (!header.id.includes("acciones")) {
        header.addEventListener('click', function () {
            var table = document.querySelector('#tablaFacturas');
            ...
            document.querySelectorAll('#tablaFacturas th').forEach(th => {
