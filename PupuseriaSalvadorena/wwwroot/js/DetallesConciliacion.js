...
document.getElementById('busqueda').addEventListener('keyup', function () {
    ...
    var rows = document.querySelectorAll('#tablaConciliacionD tbody tr');
...
// Ordernar tabla
document.querySelectorAll('#tablaConciliacionD th').forEach(header => {
    if (!header.id.includes("acciones")) {
        header.addEventListener('click', function () {
            var table = document.querySelector('#tablaConciliacionD');
            ...
            document.querySelectorAll('#tablaConciliacionD th').forEach(th => {
...
function setupPagination() {
    var table = document.querySelector('#tablaConciliacionD tbody');
    var rows = table.rows;
