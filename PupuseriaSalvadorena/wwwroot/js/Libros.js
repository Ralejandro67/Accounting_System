...
document.getElementById('busqueda').addEventListener('keyup', function () {
    ...
    var rows = document.querySelectorAll('#tablaLibro tbody tr');
...
// Ordernar tabla
document.querySelectorAll('#tablaLibro th').forEach(header => {
    if (!header.id.includes("acciones")) {
        header.addEventListener('click', function () {
            var table = document.querySelector('#tablaLibro');
            ...
            document.querySelectorAll('#tablaLibro th').forEach(th => {
...
function setupPagination() {
    var table = document.querySelector('#tablaLibro tbody');
    var rows = table.rows;
