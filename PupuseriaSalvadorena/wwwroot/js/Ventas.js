...
// Ordernar tabla
document.querySelectorAll('#tablaVentas th').forEach(header => {
    if (!header.id.includes("acciones")) {
        header.addEventListener('click', function () {
            var table = document.querySelector('#tablaVentas');
            ...
            document.querySelectorAll('#tablaVentas th').forEach(th => {
